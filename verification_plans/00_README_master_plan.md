> ⚠️ **Historical planning document.** These verification plans describe work as
> it was being planned and may be out of date. For the current, verified
> documentation see [`../docs/`](../docs/) — the Technical Reference Manual and
> the guides. These plans are also archived under `../docs/archive/`.
