...
#
# Script generated by Vivado on Mon Feb 16 01:00:59 -0500 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : phase_accumulator.sh
...
#
# Usage        : phase_accumulator.sh
#                phase_accumulator.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                phase_accumulator.sh [-rerun]
#                phase_accumulator.sh [-reset_run]
#                phase_accumulator.sh [-clean]
#                phase_accumulator.sh [-reset_log]
#                phase_accumulator.sh [-help]
#
...
# script info
echo -e "phase_accumulator.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./phase_accumulator.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot phase_accumulator xil_defaultlib.phase_accumulator xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim phase_accumulator -key {Behavioral:sim_1:Functional:phase_accumulator} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb phase_accumulator.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./phase_accumulator.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: phase_accumulator.sh [-help]\n\
Usage: phase_accumulator.sh [-step]\n\
Usage: phase_accumulator.sh [-lib_map_path]\n\
Usage: phase_accumulator.sh [-rerun]\n\
Usage: phase_accumulator.sh [-reset_run]\n\
Usage: phase_accumulator.sh [-clean]\n\
Usage: phase_accumulator.sh [-reset_log]\n\
Usage: phase_accumulator.sh [-keep_index]\n\
Usage: phase_accumulator.sh [-noclean_files]\n\n\
