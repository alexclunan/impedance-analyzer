...
REM
REM Generated by Vivado on Wed Feb 25 01:48:10 -0500 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_mag_phase_calculator_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_mag_phase_calculator_vlog.prj -log xvlog.log
