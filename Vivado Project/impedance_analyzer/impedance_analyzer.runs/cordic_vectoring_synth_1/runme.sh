...
HD_PWD='C:/Users/Alex/Documents/GitHub/impedance-analyzer/Vivado Project/impedance_analyzer/impedance_analyzer.runs/cordic_vectoring_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cordic_vectoring.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cordic_vectoring.tcl
