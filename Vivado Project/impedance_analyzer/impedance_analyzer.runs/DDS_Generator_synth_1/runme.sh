...
HD_PWD='C:/Users/Alex/Documents/GitHub/impedance-analyzer/Vivado Project/impedance_analyzer/impedance_analyzer.runs/DDS_Generator_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DDS_Generator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DDS_Generator.tcl
