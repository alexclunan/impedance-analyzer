...
HD_PWD='C:/Users/Alex/Documents/GitHub/impedance-analyzer/Vivado Project/impedance_analyzer/impedance_analyzer.runs/fir_filter_q_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_filter_q.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fir_filter_q.tcl
