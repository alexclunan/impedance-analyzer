...
HD_PWD='C:/Users/Alex/Documents/GitHub/impedance-analyzer/Vivado Project/impedance_analyzer/impedance_analyzer.runs/analog_delay_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log analog_delay_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source analog_delay_fifo.tcl
