...
HD_PWD='C:/Users/Alex/Documents/GitHub/impedance-analyzer/Vivado Project/impedance_analyzer/impedance_analyzer.runs/cic_decimator_i_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cic_decimator_i.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cic_decimator_i.tcl
