...
HD_PWD='C:/Users/Alex/Documents/GitHub/impedance-analyzer/Vivado Project/impedance_analyzer/impedance_analyzer.runs/wave_delay_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wave_delay_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wave_delay_fifo.tcl
