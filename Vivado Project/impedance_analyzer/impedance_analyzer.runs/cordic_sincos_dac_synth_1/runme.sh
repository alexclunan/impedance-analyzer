...
HD_PWD='C:/Users/Alex/Documents/GitHub/impedance-analyzer/Vivado Project/impedance_analyzer/impedance_analyzer.runs/cordic_sincos_dac_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cordic_sincos_dac.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cordic_sincos_dac.tcl
