...
--               Project/impedance_analyzer/impedance_analyzer.gen/sources_1/ip/dac_driver/dac_driver_sim_netlist.vhdl}
-- Design      : dac_driver
...
entity dac_driver_selectio_wiz is
  port (
  ...
  attribute DEV_W of dac_driver_selectio_wiz : entity is 16;
  attribute SYS_W : integer;
  attribute SYS_W of dac_driver_selectio_wiz : entity is 16;
end dac_driver_selectio_wiz;

architecture STRUCTURE of dac_driver_selectio_wiz is
...
entity dac_driver is
  ...
  attribute NotValidForBitStream of dac_driver : entity is true;
  attribute DEV_W : integer;
  attribute DEV_W of dac_driver : entity is 16;
  attribute SYS_W : integer;
  attribute SYS_W of dac_driver : entity is 16;
end dac_driver;

architecture STRUCTURE of dac_driver is
  attribute DEV_W of inst : label is 16;
  attribute SYS_W of inst : label is 16;
begin
inst: entity work.dac_driver_selectio_wiz
     port map (
      clk_in_n => clk_in_n,
      clk_in_p => clk_in_p,
      clk_out => clk_out,
