...
entity zsys is
  ...
  attribute CORE_GENERATION_INFO of zsys : entity is "zsys,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=zsys,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=4,numReposBlks=4,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=Hierarchical}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of zsys : entity is "zsys.hwdef";
end zsys;

architecture STRUCTURE of zsys is
  component zsys_SC0720_0_0 is
  port (
  ...
  signal PHY_LEDs : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal SC0720_0_PHY_LED0 : STD_LOGIC;
  signal SC0720_0_PHY_LED1 : STD_LOGIC;
  signal SC0720_0_PHY_LED2 : STD_LOGIC;
  ...
  signal NLW_SC0720_0_ext_scl_o_UNCONNECTED : STD_LOGIC;
  signal NLW_SC0720_0_ext_scl_t_UNCONNECTED : STD_LOGIC;
  signal NLW_SC0720_0_ext_sda_o_UNCONNECTED : STD_LOGIC;
  signal NLW_SC0720_0_ext_sda_t_UNCONNECTED : STD_LOGIC;
...
begin
SC0720_0: component zsys_SC0720_0_0
     port map (
      PHY_LED0 => SC0720_0_PHY_LED0,
      ...
      ext_scl_i => '1',
      ext_scl_o => NLW_SC0720_0_ext_scl_o_UNCONNECTED,
      ext_scl_t => NLW_SC0720_0_ext_scl_t_UNCONNECTED,
      ext_sda_i => '1',
      ext_sda_o => NLW_SC0720_0_ext_sda_o_UNCONNECTED,
      ext_sda_t => NLW_SC0720_0_ext_sda_t_UNCONNECTED,
...
vio_0: component zsys_vio_0_0
     port map (
      ...
      probe_in0(2 downto 0) => PHY_LEDs(2 downto 0)
    );
xlconcat_0: component zsys_xlconcat_0_0
     port map (
      In0(0) => SC0720_0_PHY_LED0,
      In1(0) => SC0720_0_PHY_LED1,
      In2(0) => SC0720_0_PHY_LED2,
      dout(2 downto 0) => PHY_LEDs(2 downto 0)
    );
end STRUCTURE;
