catch {TE::UTILS::te_msg TE_BD-0 INFO "This block design tcl-file was generate with Trenz Electronic GmbH Board Part:trenz.biz:te0720_20_1c:part0:1.0, FPGA: xc7z020clg484-1 at 2025-05-09T10:20:19."}
...
# #TE_MOD#   set FIXED_IO [ create_bd_intf_port -mode Master -vlnv xilinx.com:display_processing_system7:fixedio_rtl:1.0 FIXED_IO ]
  ...
  set SC0720_0 [ create_bd_cell -type ip -vlnv trenz.biz:user:SC0720 SC0720_0 ]
...
# #TE_MOD#     CONFIG.PCW_DDR_RAM_HIGHADDR {0x3FFFFFFF} \
...
# #TE_MOD#     CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO#Quad SPI Flash#GPIO#I2C 0#I2C 0#UART 1#UART 1#UART 0#UART 0#Enet\
# #TE_MOD# 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 1#SD 1#SD 1#SD 1#SD\
# #TE_MOD# 1#SD 1#Enet 0#Enet 0} \
...
# #TE_MOD#   connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  ...
  connect_bd_net -net PHY_LEDs  [get_bd_pins xlconcat_0/dout] \
  [get_bd_pins vio_0/probe_in0]
  connect_bd_net -net PL_pin_K16_1  [get_bd_ports PL_pin_K16] \
  [get_bd_pins SC0720_0/PL_pin_K16]
  connect_bd_net -net PL_pin_K19_1  [get_bd_ports PL_pin_K19] \
  [get_bd_pins SC0720_0/PL_pin_K19]
  connect_bd_net -net PL_pin_M15_1  [get_bd_ports PL_pin_M15] \
  [get_bd_pins SC0720_0/PL_pin_M15]
  connect_bd_net -net PL_pin_N15_1  [get_bd_ports PL_pin_N15] \
  [get_bd_pins SC0720_0/PL_pin_N15]
  connect_bd_net -net PL_pin_P16_1  [get_bd_ports PL_pin_P16] \
  [get_bd_pins SC0720_0/PL_pin_P16]
  connect_bd_net -net PL_pin_P22_1  [get_bd_ports PL_pin_P22] \
  [get_bd_pins SC0720_0/PL_pin_P22]
  connect_bd_net -net SC0720_0_PHY_LED0  [get_bd_pins SC0720_0/PHY_LED0] \
  [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net SC0720_0_PHY_LED1  [get_bd_pins SC0720_0/PHY_LED1] \
  [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net SC0720_0_PHY_LED2  [get_bd_pins SC0720_0/PHY_LED2] \
  [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net SC0720_0_PL_pin_K20  [get_bd_pins SC0720_0/PL_pin_K20] \
  [get_bd_ports PL_pin_K20]
  connect_bd_net -net SC0720_0_PL_pin_L16  [get_bd_pins SC0720_0/PL_pin_L16] \
  [get_bd_ports PL_pin_L16]
  connect_bd_net -net SC0720_0_PL_pin_N22  [get_bd_pins SC0720_0/PL_pin_N22] \
  [get_bd_ports PL_pin_N22]
