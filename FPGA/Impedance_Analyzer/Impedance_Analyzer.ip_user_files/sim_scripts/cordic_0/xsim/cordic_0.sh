...
#
# Script generated by Vivado on Thu Feb 05 13:28:12 -0500 2026
...
# script info
echo -e "cordic_0.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xbip_utils_v3_0_15 -L c_reg_fd_v12_0_11 -L xbip_dsp48_wrapper_v3_0_7 -L xbip_pipe_v3_0_11 -L c_addsub_v12_0_21 -L mult_gen_v12_0_24 -L axi_utils_v2_0_11 -L cordic_v6_0_25 -L secureip -L xpm --snapshot cordic_0 xil_defaultlib.cordic_0 -log elaborate.log
}
...
Usage: cordic_0.sh [-rerun]\n\
Usage: cordic_0.sh [-reset_run]\n\
Usage: cordic_0.sh [-clean]\n\
